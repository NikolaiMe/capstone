...
class CapstoneTestCase(unittest.TestCase):
    ...
    def test_create_new_actor(self):
        ...
        res = self.client().post('/actors',
                                 json=actor_to_be_created, headers=self.header)
        data = json.loads(res.data)
    ...
    def test_delete_actor(self):
        ...
        res = self.client().delete(
            '/actors/{}'.format(actor_id_to_delete),
            headers=self.header)
        data = json.loads(res.data)
    ...
    def test_404_delete_actor(self):
        actor_id_to_delete = Actors.query.order_by(
            Actors.id.desc()).first().id + 1
        res = self.client().delete(
            '/actors/{}'.format(actor_id_to_delete),
            headers=self.header)
        data = json.loads(res.data)
    ...
    def test_change_actor(self):
        ...
        res = self.client().patch(
            '/actors/{}'.format(actor_id_to_change),
            json=changes_to_be_made,
            headers=self.header)
        data = json.loads(res.data)
    ...
    def test_404_change_actor(self):
        ...
        actor_id_to_change = Actors.query.order_by(
            Actors.id.desc()).first().id + 1
        res = self.client().patch(
            '/actors/{}'.format(actor_id_to_change),
            json=changes_to_be_made,
    ...
    def test_create_new_movie(self):
        ...
        self.assertTrue(
            new_movie.releasedate.strftime("%Y-%m-%d %H:%M:%S"),
            movie_to_be_created['releasedate'])
    ...
    def test_delete_movie(self):
        ...
        res = self.client().delete(
            '/movies/{}'.format(movie_id_to_delete),
            headers=self.header)
        data = json.loads(res.data)
    ...
    def test_404_delete_movie(self):
        movie_id_to_delete = Movies.query.order_by(
            Movies.id.desc()).first().id + 1
        res = self.client().delete(
            '/movies/{}'.format(movie_id_to_delete),
            headers=self.header)
        data = json.loads(res.data)
    ...
    def test_change_movie(self):
        ...
        res = self.client().patch(
            '/movies/{}'.format(movie_id_to_change),
            json=changes_to_be_made,
            headers=self.header)
        data = json.loads(res.data)
        ...
        self.assertTrue(changed_movie.releasedate.strftime(
            "%Y-%m-%d %H:%M:%S"), changes_to_be_made['releasedate'])
    ...
    def test_404_change_movie(self):
        ...
        movie_id_to_change = Movies.query.order_by(
            Movies.id.desc()).first().id + 1
        res = self.client().patch(
            '/movies/{}'.format(movie_id_to_change),
            json=changes_to_be_made,
